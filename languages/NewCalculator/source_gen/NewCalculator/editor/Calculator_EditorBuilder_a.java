...
/*package*/ class Calculator_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private static class inputFieldListHandler_uh00px_c0 extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.inputField$CCdI;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.InputField$Q4;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(inputFieldListHandler_uh00px_c0.this.getNode(), LINKS.inputField$CCdI));
      try {
  ...
  private static class outputFieldListHandler_uh00px_e0 extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.outputField$gVmi;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.OutputField$EL;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(outputFieldListHandler_uh00px_e0.this.getNode(), LINKS.outputField$gVmi));
      try {
        EditorCell emptyCell = null;
        emptyCell = super.createEmptyCell();
        installElementCellActions(null, emptyCell, true);
  ...
  private static final class CONCEPTS {
    ...
    /*package*/ static final SConcept InputField$Q4 = MetaAdapterFactory.getConcept(0xe2527d9f08044b88L, 0xb92a085f8ba5108bL, 0x18346be4006f2c15L, "NewCalculator.structure.InputField");
    /*package*/ static final SConcept OutputField$EL = MetaAdapterFactory.getConcept(0xe2527d9f08044b88L, 0xb92a085f8ba5108bL, 0x18346be4006f891aL, "NewCalculator.structure.OutputField");
  }
