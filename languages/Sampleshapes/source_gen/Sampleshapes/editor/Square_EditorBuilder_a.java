...
/*package*/ class Square_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      final SProperty property = PROPS.x$9Q3P;
  ...
  private EditorCell createProperty_1() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.y$9Q4N;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, false, false), myNode);
  ...
  private EditorCell createProperty_2() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.size$9Qgr;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, false, false), myNode);
  ...
  private static final class PROPS {
    /*package*/ static final SProperty x$9Q3P = MetaAdapterFactory.getProperty(0xda65a42c0c5347b5L, 0xa79a1e8fc7d7bd5aL, 0x3d1ab7b3d06e8167L, 0x26bcded31fc273c0L, "x");
    /*package*/ static final SProperty y$9Q4N = MetaAdapterFactory.getProperty(0xda65a42c0c5347b5L, 0xa79a1e8fc7d7bd5aL, 0x3d1ab7b3d06e8167L, 0x26bcded31fc273c2L, "y");
    /*package*/ static final SProperty size$9Qgr = MetaAdapterFactory.getProperty(0xda65a42c0c5347b5L, 0xa79a1e8fc7d7bd5aL, 0x3d1ab7b3d06e8167L, 0x26bcded31fc273c5L, "size");
  }
