...
/*package*/ class Circle_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      final SProperty property = PROPS.x$9PMo;
  ...
  private EditorCell createProperty_1() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.y$9PNm;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, false, false), myNode);
  ...
  private EditorCell createProperty_2() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.radius$9Q0U;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, false, false), myNode);
  ...
  private EditorCell createComponent_0() {
    EditorCell editorCell = getCellFactory().createEditorComponentCell(myNode, "SampleShapes.editor.ShapeColor");
    return editorCell;
  }

  private static final class PROPS {
    /*package*/ static final SProperty x$9PMo = MetaAdapterFactory.getProperty(0xda65a42c0c5347b5L, 0xa79a1e8fc7d7bd5aL, 0x3d1ab7b3d06e8166L, 0x26bcded31fc273b1L, "x");
    /*package*/ static final SProperty y$9PNm = MetaAdapterFactory.getProperty(0xda65a42c0c5347b5L, 0xa79a1e8fc7d7bd5aL, 0x3d1ab7b3d06e8166L, 0x26bcded31fc273b3L, "y");
    /*package*/ static final SProperty radius$9Q0U = MetaAdapterFactory.getProperty(0xda65a42c0c5347b5L, 0xa79a1e8fc7d7bd5aL, 0x3d1ab7b3d06e8166L, 0x26bcded31fc273baL, "radius");
  }
